  ...
  return <LoaderSpinner/>
    ...
    <section className="flex w-full flex-col">
      <header className="mt-9 flex items-center justify-between">
        <h1 className="text-20 font-bond text-white-1">
          Currently Playing 
        </h1>
      ...
      />
        ...
        <div className="flex flex-col gap-8">
          <div className="flex flex-col gap-4">
            ...
            <p className="text-14 font-medium text-white-2">{podcast?.voicePrompt}</p>
          </div>
          <div className="flex flex-col gap-4">
            <h1 className="text-16 font-bold text-white-1">Thumbnail Prompt</h1>
            <p className="text-14 font-medium text-white-2">{podcast?.imagePrompt}</p>
          </div>
        </div>

        <section className="mt-8 flex flex-col gap-5">
          <h1 className="text-18 font-bond text-white-1">Similar Podcasts</h1>
